...
/// excpt: &
/// ctx: &
extern hlt_string hlt_bitset_to_string(const hlt_type_info* type, const void* obj, int32_t options,
...
/// excpt: &
/// ctx: &
extern int64_t hlt_bitset_to_int64(const hlt_type_info* type, const void* obj, int32_t options,
