...
extern int hlt_struct_size(const hlt_type_info* type, hlt_exception** excpt, hlt_execution_context* ctx);
...
extern int8_t hlt_struct_is_set(const hlt_type_info* type, void* obj, int index, hlt_exception** excpt, hlt_execution_context* ctx);
...
extern void* hlt_struct_get(const hlt_type_info* type, void* obj, int index, hlt_exception** excpt, hlt_execution_context* ctx);
...
/// \hlt_c
///
/// Returns: A pointer to the meta information. All pointers in there must be left untouched, ownership is *not* passed to caller.
extern hlt_struct_field hlt_struct_get_type(const hlt_type_info* type, int index, hlt_exception** excpt, hlt_execution_context* ctx);
