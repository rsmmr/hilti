...
extern hlt_string hlt_string_decode(struct __hlt_bytes*, hlt_string charset, hlt_exception** excpt, hlt_execution_context* ctx);
...
/// This passes ownership of the returned value to the caller.
