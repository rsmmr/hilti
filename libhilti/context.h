...
/// Refs an execution context.
///
/// ctx: The context to be ref.
extern void __hlt_execution_context_ref(hlt_execution_context* ctx);

/// Unrefs an execution context.
///
/// ctx: The context to be destroyed.
extern void __hlt_execution_context_unref(hlt_execution_context* ctx);
