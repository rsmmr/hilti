...
extern hlt_string hlt_port_to_string(const hlt_type_info* type, const void* obj, int32_t options,
                                     __hlt_pointer_stack* seen, hlt_exception** excpt,
                                     hlt_execution_context* ctx);
extern int64_t hlt_port_to_int64(const hlt_type_info* type, const void* obj, int32_t options,
                                 hlt_exception** expt, hlt_execution_context* ctx);

// Parses strings of the form "123/tcp" and "345/udp".
extern hlt_port hlt_port_from_asciiz(const char* str, hlt_exception** excpt,
                                     hlt_execution_context* ctx);
