...
{
    return a.nid != b.nid ? SET_STD_EQUAL(a.nid, b.nid)
                          : SET_STD_EQUAL(a.tid, b.tid);
};
...
KHASH_INIT(dfa_state_elem, set_dfa_state_elem, jrx_dfa_state_id, 1, _jrx_hash_dfa_state_elem, _jrx_eq_set_dfa_state_elem);
...
extern int dfa_state_compute(jrx_nfa_context* ctx, jrx_dfa* dfa, jrx_dfa_state_id id, set_dfa_state_elem* dstate, int recurse);
