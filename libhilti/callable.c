...
void* hlt_callable_clone_alloc(const hlt_type_info* ti, void* srcp, __hlt_clone_state* cstate,
...
void hlt_callable_clone_init(void* dstp, const hlt_type_info* ti, void* srcp,
