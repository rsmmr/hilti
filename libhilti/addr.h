...
/// excpt: &
/// ctx: &
extern hlt_string hlt_addr_to_string(const hlt_type_info* type, const void* obj, int32_t options,
...
/// excpt: &
/// ctx: &
extern struct in_addr hlt_addr_to_in4(hlt_addr addr, hlt_exception** excpt,
                                      hlt_execution_context* ctx);
...
/// excpt: &
/// ctx: &
extern struct in6_addr hlt_addr_to_in6(hlt_addr addr, hlt_exception** excpt,
                                       hlt_execution_context* ctx);
...
///
/// excpt: &
extern hlt_addr hlt_addr_from_in4(struct in_addr in, hlt_exception** excpt,
                                  hlt_execution_context* ctx);
...
///
/// excpt: &
extern hlt_addr hlt_addr_from_in6(struct in6_addr in, hlt_exception** excpt,
                                  hlt_execution_context* ctx);
...
extern hlt_addr hlt_addr_from_asciiz(const char* s, hlt_exception** excpt,
                                     hlt_execution_context* ctx);
