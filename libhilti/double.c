...
hlt_string hlt_double_to_string(const hlt_type_info* type, const void* obj, int32_t options,
...
double hlt_double_to_double(const hlt_type_info* type, const void* obj, int32_t options,
