...
struct __hlt_timer {
    ...
    hlt_timer_mgr*
        mgr;          // The timer manager the timer belongs to. No memory-managed to avoid cycles.
...
extern hlt_string hlt_timer_to_string(const hlt_type_info* type, const void* obj, int32_t options,
...
///
/// This function has the standard RTTI signature.
extern double hlt_timer_to_double(const hlt_type_info* type, const void* obj, int32_t options,
                                  hlt_exception** exception, hlt_execution_context* ctx);
...
///
/// This function has the standard RTTI signature.
extern int64_t hlt_timer_to_int64(const hlt_type_info* type, const void* obj, int32_t options,
                                  hlt_exception** exception, hlt_execution_context* ctx);
...
extern void hlt_timer_mgr_schedule(hlt_timer_mgr* mgr, hlt_time t, hlt_timer* timer,
...
///
/// excpt: &
extern void hlt_timer_mgr_advance_global(hlt_time t, hlt_exception** excpt,
                                         hlt_execution_context* ctx);
...
///
/// This function has the standard RTTI signature.
extern hlt_string hlt_timer_mgr_to_string(const hlt_type_info* type, const void* obj,
...
///
/// This function has the standard RTTI signature.
extern double hlt_timer_mgr_to_double(const hlt_type_info* type, const void* obj, int32_t options,
                                      hlt_exception** exception, hlt_execution_context* ctx);
...
///
/// This function has the standard RTTI signature.
extern int64_t hlt_timer_mgr_to_int64(const hlt_type_info* type, const void* obj, int32_t options,
                                      hlt_exception** exception, hlt_execution_context* ctx);
...
extern hlt_timer* __hlt_timer_new_function(hlt_callable* func, hlt_exception** excpt,
                                           hlt_execution_context* ctx);
...
///
/// Returns: The new timer object.
extern hlt_timer* __hlt_timer_new_vector(__hlt_vector_timer_cookie cookie, hlt_exception** excpt,
                                         hlt_execution_context* ctx);
...
///
/// Returns: The new timer object.
extern hlt_timer* __hlt_timer_new_profiler(__hlt_profiler_timer_cookie cookie,
                                           hlt_exception** excpt, hlt_execution_context* ctx);
