...
/// excpt: &
/// ctx: &
extern void hlt_clone_deep(void* dstp, const hlt_type_info* ti, const void* srcp,
...
/// excpt: &
/// ctx: &
extern void hlt_clone_shallow(void* dstp, const hlt_type_info* ti, const void* srcp,
                              hlt_exception** excpt, hlt_execution_context* ctx);
...
/// excpt: &
/// ctx: &
extern void hlt_clone_for_thread(void* dstp, const hlt_type_info* ti, const void* srcp,
                                 hlt_vthread_id vid, hlt_exception** excpt,
...
/// function.
extern void __hlt_clone(void* dstp, const hlt_type_info* ti, const void* srcp,
                        __hlt_clone_state* cstate, hlt_exception** excpt,
                        hlt_execution_context* ctx);

typedef void (*__hlt_init_in_thread_callback)(const hlt_type_info* ti, void* dstp,
                                              hlt_exception** excpt, hlt_execution_context* ctx);
...
/// later if not.
extern void __hlt_clone_init_in_thread(__hlt_init_in_thread_callback cb, const hlt_type_info* ti,
