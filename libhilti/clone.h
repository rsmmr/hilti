...
///
/// type: Specifies the type of the clone operation as a value of \c
/// HLT_CLONE_*.
///
/// excpt: &
/// ctx: & 
extern void hlt_clone(void* dstp, const hlt_type_info* ti, void* srcp, int16_t type, hlt_exception** excpt, hlt_execution_context* ctx);
...
/// excpt: &
/// ctx: & 
extern void hlt_clone_for_thread(void* dstp, const hlt_type_info* ti, void* srcp, hlt_vthread_id vid, hlt_exception** excpt, hlt_execution_context* ctx);
...
/// function.
extern void __hlt_clone(void* dstp, const hlt_type_info* ti, void* srcp, __hlt_clone_state* cstate, hlt_exception** excpt, hlt_execution_context* ctx);
