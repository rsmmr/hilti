...
#ifndef SPICY_CODEGEN_TYPE_BUILDER_H
#define SPICY_CODEGEN_TYPE_BUILDER_H
...
// Codegen information about a Spicy type.
struct TypeInfo {
    typedef std::function<shared_ptr<hilti::Expression>(CodeGen* cg, shared_ptr<spicy::Type> t)>
        expression_callback;
...
/// Visitor that returns the HILTI type that corresponds to a Spicy type.
...
private:
    shared_ptr<::hilti::Type> _buildType(shared_ptr<::hilti::Type> type, int spicy_type,
                                         shared_ptr<::hilti::Expression> aux = nullptr);
    void _addHostType(shared_ptr<::hilti::Type> type, int spicy_type,
                      shared_ptr<::hilti::Expression> aux = nullptr);
