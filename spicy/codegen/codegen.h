...
#ifndef SPICY_CODEGEN_CODEGEN_H
#define SPICY_CODEGEN_CODEGEN_H
...
public:
    ...
    /// Compiles a Spicy module into a HILTI module.
    ///
    ...
    /// Returns the HILTI epxression resulting from evaluating a Spicy
    ...
    /// Compiles a Spicy statement into HILTI. The method adds the code to
    /// current HILTI block.
    ///
    /// stmt: The statement to compile
    void hiltiStatement(shared_ptr<Statement> stmt);

    /// Converts a Spicy type into its corresponding HILTI type.
    ///
    ...
    /// Returns the HILTI type associated with a Spicy integer type.
    ///
    ...
    /// Returns the HILTI type associated with a Spicy optional type.
    ///
    ...
    /// Returns a HILTI constant expression of Spicy integer type.
    ///
    ...
    /// Returns a HILTI constant expression of Spicy optional type.
    ///
    ...
    /// Returns the HILTI name that is associated with a Spicy type. This
    ...
    /// Coerces a HILTI expression of one Spicy type into another. The
    /// method assumes that the coercion is legel.
    ///
    /// expr: The HILTI expression to coerce.
    ///
    /// src: The Spicy type that \a expr currently has.
    ///
    /// dst: The Spicy type that \a expr is to be coerced into.
    ///
    ...
    /// Returns the default value for instances of a Spicy type that aren't
    /// further intiailized.
    ///
    /// type: The type to convert.
    ///
    ...
    /// Turns a Spicy ID into a HILTI ID.
    ///
    ...
    void hiltiRunFieldHooks(shared_ptr<spicy::type::Unit> unit, shared_ptr<type::unit::Item> item,
    ...
    ///
    /// cookie: The cookie parameter to pass to the hook.
    shared_ptr<hilti::Expression> hiltiRunHook(shared_ptr<spicy::type::Unit> unit,
    ...
    ///
    /// btype: The Spicy type that htype corresponds to.
    ...
    void hiltiConfirm(shared_ptr<hilti::Expression> self, shared_ptr<spicy::type::Unit> unit,
    ...
    /// host application.
    void hiltiDisable(shared_ptr<hilti::Expression> self, shared_ptr<spicy::type::Unit> unit,
                      const string& msg);
    ...
    shared_ptr<hilti::ID> hiltiFunctionName(shared_ptr<spicy::Function> func,
                                            const string& scope = "");
    ...
    /// Converts an expression of type Spicy::ByteOrder into a HILTI value of type
    /// Hilti::ByteOrder.
    ///
    ...
    /// Converts an expression of type Spicy::Charset into a HILTI value of type Hilti::Charset.
    ///
    /// expr: The expression to convert.
    ///
    ...
    //
    // byteorder: a Spicy expression of type Spicy::ByteOrder. If \a null,
    ...
    // Returns the Spicy::Parser instance for a unit.
    //
...
private:
    ...
    // explicitly enabled via libspicy.  If \a compose is true, we define a
    ...
    // Creates the init function that registers a parser with the Spicy runtime.
