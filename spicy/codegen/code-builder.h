...
#ifndef SPICY_CODEGEN_CODE_BUILDER_H
#define SPICY_CODEGEN_CODE_BUILDER_H
...
public:
    ...
    /// Compiles a Spicy statement into HILTI.
    ///
...
/// classes.
#include <spicy/autogen/operators/operators-expression-builder.h>
