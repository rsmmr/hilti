                                     ...
                                     const std::string& tag)
{
    ...
    cg()->builder()->addInstruction(eod, hilti::instruction::bytes::IsFrozenIterBytes,
                                    state()->cur);
...
{
    auto mtype = hilti::builder::tuple::type(
        {hilti::builder::boolean::type(), hilti::builder::iterator::typeBytes()});
    ...
    cg()->builder()->addInstruction(match, hilti::instruction::bytes::FindAtIter, state()->cur,
                                    hilti::builder::bytes::create(data));
    cg()->builder()->addInstruction(success, hilti::instruction::tuple::Index, match,
                                    hilti::builder::integer::create(0));
    cg()->builder()->addInstruction(state()->cur, hilti::instruction::tuple::Index, match,
    ...
    if ( state()->type == SynchronizeAfter )
        ...
        cg()->builder()->addInstruction(state()->cur, hilti::instruction::operator_::IncrBy,
                                        state()->cur, hilti::builder::integer::create(data.size()));
...
void Synchronizer::_hiltiSynchronizeOnRegexp(
    const hilti::builder::regexp::re_pattern_list& patterns)
{
    auto mtype = hilti::builder::tuple::type(
        {hilti::builder::boolean::type(), hilti::builder::iterator::typeBytes()});
    ...
    cg()->builder()->addInstruction(mresult, hilti::instruction::regexp::MatchTokenAdvanceBytes,
                                    mstate, i, eob);
    cg()->builder()->addInstruction(rc, hilti::instruction::tuple::Index, mresult,
                                    hilti::builder::integer::create(0));
    cg()->builder()->addInstruction(i, hilti::instruction::tuple::Index, mresult,
                                    hilti::builder::integer::create(1));
    cg()->builder()->addInstruction(b, hilti::instruction::integer::Slt, rc,
                                    hilti::builder::integer::create(0));
    ...
    cg()->builder()->addInstruction(b, hilti::instruction::integer::Sgt, rc,
                                    hilti::builder::integer::create(0));
    ...
    cg()->builder()->addInstruction(state()->cur, hilti::instruction::operator_::Incr,
                                    state()->cur);
    cg()->builder()->addInstruction(hilti::instruction::bytes::Trim, state()->data, state()->cur);
    cg()->builder()->addInstruction(hilti::instruction::flow::Jump, loop_outer->block());
...
Synchronizer::Synchronizer(CodeGen* cg) : CGVisitor<>(cg, "Synchronizer")
{
}
...
shared_ptr<hilti::Expression> Synchronizer::hiltiSynchronize(shared_ptr<Production> p,
...
shared_ptr<hilti::Expression> Synchronizer::hiltiSynchronize(shared_ptr<type::Unit> unit,
                                                             shared_ptr<hilti::Expression> data,
                                                             shared_ptr<hilti::Expression> cur)
{
...
void Synchronizer::visit(type::EmbeddedObject* o)
{
    ...
    cg()->builder()->addInstruction(state()->cur, hilti::instruction::bytes::NextObject,
                                    state()->cur);
...
void Synchronizer::visit(type::Mark* m)
{
    ...
    cg()->builder()->addInstruction(state()->cur, hilti::instruction::bytes::NextMark,
                                    state()->cur);
