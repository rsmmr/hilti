...
#include <spicy/autogen/operators/integer.h>

using namespace spicy;
using namespace spicy::codegen;

static shared_ptr<spicy::type::Integer> _intResultType(spicy::expression::ResolvedOperator* op)
{
    auto t1 = ast::rtti::checkedCast<spicy::type::Integer>(op->op1()->type());
    auto t2 = ast::rtti::checkedCast<spicy::type::Integer>(op->op2()->type());
    ...
    return std::make_shared<spicy::type::Integer>(width, sign);
}
