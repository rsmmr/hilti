...
#include <spicy/autogen/operators/unit.h>
...
void CodeBuilder::visit(spicy::expression::operator_::unit::HasAttribute* i)
{
    auto unit = ast::rtti::checkedCast<type::Unit>(i->op1()->type());
    auto attr = ast::rtti::checkedCast<expression::MemberAttribute>(i->op2());
...
void CodeBuilder::visit(spicy::expression::operator_::unit::TryAttribute* i)
{
    auto unit = ast::rtti::checkedCast<type::Unit>(i->op1()->type());
    auto attr = ast::rtti::checkedCast<expression::MemberAttribute>(i->op2());
    ...
    cg()->builder()->addThrow("SpicyHilti::AttributeNotSet",
...
void CodeBuilder::visit(spicy::expression::operator_::unit::New* i)
{
...
void CodeBuilder::visit(spicy::expression::operator_::unit::Input* i)
{
...
void CodeBuilder::visit(spicy::expression::operator_::unit::Offset* i)
{
    auto self = cg()->hiltiExpression(i->op1());
...
void CodeBuilder::visit(spicy::expression::operator_::unit::SetPosition* i)
{
    auto self = cg()->hiltiExpression(i->op1());
...
void CodeBuilder::visit(spicy::expression::operator_::unit::AddFilter* i)
{
    auto self = cg()->hiltiExpression(i->op1());
    ...
    auto filter_type = cg()->hiltiCastEnum(cg()->hiltiExpression(filter),
                                           hilti::builder::type::byName("SpicyHilti::Filter"));

    auto ft =
        hilti::builder::reference::type(hilti::builder::type::byName("SpicyHilti::ParseFilter"));
    ...
    cg()->builder()->addInstruction(head, hilti::instruction::flow::CallResult,
                                    hilti::builder::id::create("SpicyHilti::filter_add"),
...
void CodeBuilder::visit(spicy::expression::operator_::unit::Disconnect* i)
{
    auto self = cg()->hiltiExpression(i->op1());

    auto ft = hilti::builder::reference::type(hilti::builder::type::byName("SpicyHilti::Sink"));
    ...
    cg()->builder()->addInstruction(hilti::instruction::flow::CallVoid,
                                    hilti::builder::id::create("SpicyHilti::sink_disconnect"),
                                    hilti::builder::tuple::create({sink, self}));

    setResult(std::make_shared<hilti::expression::Void>());
}

void CodeBuilder::visit(spicy::expression::operator_::unit::MimeType* i)
{
    auto self = cg()->hiltiExpression(i->op1());
...
void CodeBuilder::visit(spicy::expression::operator_::unit::Backtrack* i)
{
    cg()->builder()->addThrow("SpicyHilti::Backtrack",
                              ::hilti::builder::string::create("backtracking triggered"));
    setResult(std::make_shared<hilti::expression::Void>());
}

void CodeBuilder::visit(spicy::expression::operator_::unit::Confirm* i)
{
    auto self = cg()->hiltiExpression(i->op1());
    auto unit = ast::rtti::checkedCast<spicy::type::Unit>(i->op1()->type());
...
void CodeBuilder::visit(spicy::expression::operator_::unit::Disable* i)
{
    auto self = cg()->hiltiExpression(i->op1());
    auto unit = ast::rtti::checkedCast<spicy::type::Unit>(i->op1()->type());
