...
static shared_ptr<spicy::Type> _makeUInt64()
{
    return std::make_shared<spicy::type::Integer>(64, false);
}
...
static const string _doc_add_filter =
    R"(
    Adds an input filter as specificed by *t* (of type ~~Spicy::Filter) to the
    ...
    ~~Spicy::Filter. One cannot define own filters in Spicy.
...
static const string _doc_set_policy =
   ...
   The default policy is \a Spicy::ReassemblyPolicy::First, which resolved ambigiuities by taking
