...
expression::operator_::address::Equal::Equal(shared_ptr<Operator> op, const expression_list& ops, shared_ptr<spicy::Module> module, const Location& l)
...
operator_::address::Equal::_factory(shared_ptr<Operator> op, const expression_list& ops, shared_ptr<spicy::Module> module, const Location& l)
{
    return shared_ptr<expression::ResolvedOperator>(new expression::operator_::address::Equal(op, ops, module, l));
}
...
expression::operator_::address::Family::Family(shared_ptr<Operator> op, const expression_list& ops, shared_ptr<spicy::Module> module, const Location& l)
    :  expression::ResolvedOperator(op, ops, module, l)
{
}
...
shared_ptr<expression::ResolvedOperator>
operator_::address::Family::_factory(shared_ptr<Operator> op, const expression_list& ops, shared_ptr<spicy::Module> module, const Location& l)
{
    return shared_ptr<expression::ResolvedOperator>(new expression::operator_::address::Family(op, ops, module, l));
}
...
AST_RTTI_BEGIN(spicy::expression::resolved::address::Family, spicy_expression_resolved_address_family)
AST_RTTI_PARENT(spicy::operator::ResolvedOperator)
