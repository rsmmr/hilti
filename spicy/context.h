...
#ifndef SPICY_CONTEXT_H
#define SPICY_CONTEXT_H
...
public:
    ...
    /// Reads a Spicy source file and returns the parsed AST. The function
    ...
    /// Parses Spicy source code into a module AST. Note that before the
    ...
    /// Compiles a Spicy source file into an LLVM module. Internally, this
    ...
    /// Links a set of compiled Spicy modules into a single LLVM module.
    ...
    /// (optional).
    ///
    /// add_stdlibs: Link in Spicy's standard runtime libraries (and HILTI
    ...
    shared_ptr<::hilti::Type> hiltiType(shared_ptr<spicy::Type> type, id_list* deps = nullptr);

    /// Renders an AST back into Spicy source code.
    ///
