...
using namespace spicy::production;
...
production::Constant::Constant(const string& symbol, shared_ptr<spicy::Constant> constant,
...
shared_ptr<spicy::Constant> production::Constant::constant() const
{
    return _const;
}
...
production::Ctor::Ctor(const string& symbol, shared_ptr<spicy::Ctor> ctor,
                       shared_ptr<Expression> expr, filter_func filter, const Location& l)
...
shared_ptr<spicy::Ctor> production::Ctor::ctor() const
{
    return _ctor;
}
...
production::TypeLiteral::TypeLiteral(const string& symbol, shared_ptr<spicy::Type> type,
...
shared_ptr<spicy::Type> production::TypeLiteral::type() const
{
    return _type;
}
