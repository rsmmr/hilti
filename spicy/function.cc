...
Function::Function(shared_ptr<ID> id, shared_ptr<spicy::type::Function> ftype,
                   shared_ptr<Module> module, shared_ptr<spicy::Statement> body, const Location& l)
...
Hook::Hook(shared_ptr<spicy::Statement> body, Kind kind, int prio, bool debug, bool foreach,
