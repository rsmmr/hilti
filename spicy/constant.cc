...
using namespace spicy::constant;
...
#if 0
constant::Expression::Expression(shared_ptr<Type> type, shared_ptr<spicy::Expression> expr, const Location& l)
{
    _expr = expr;
...
shared_ptr<spicy::Expression> constant::Expression::expression() const
{
    return _expr;
}
