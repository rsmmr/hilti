...
#ifndef SPICY_STATEMENT_H
#define SPICY_STATEMENT_H
...
public:
    ...
    ForEach(shared_ptr<ID> id, shared_ptr<spicy::Expression> seq, shared_ptr<Block> body,
            const Location& l = Location::None);
    ...
    shared_ptr<spicy::Expression> sequence() const;
...
private:
    node_ptr<spicy::Expression> _seq;
...
private:
    std::list<node_ptr<spicy::Expression>> _exprs;
};
...
public:
    ...
    ///
    /// l: Associated location.
    Expression(shared_ptr<spicy::Expression> expr, const Location& l = Location::None);
...
private:
    node_ptr<spicy::Expression> _expr;
};
...
public:
    ...
    ///    /// Constructor.
    /// l: Associated location information.
    IfElse(shared_ptr<spicy::Expression> cond, shared_ptr<Statement> true_,
           shared_ptr<Statement> false_ = nullptr, const Location& l = Location::None);

    /// Returns the condition.
    shared_ptr<spicy::Expression> condition() const;
...
private:
    node_ptr<spicy::Expression> _cond;
...
public:
    ...
    ///
    /// l: Associated location information.
    Return(shared_ptr<spicy::Expression> expr, const Location& l = Location::None);
