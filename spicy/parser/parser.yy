...
%{
namespace spicy_parser { class Parser; }

#include <spicy/parser/driver.h>

%}

%locations

%name-prefix "spicy_parser"
...
%{
#include <spicy/parser/scanner.h>
...
inline ast::Location loc(const spicy_parser::Parser::location_type& ploc)
{
...
inline shared_ptr<Expression> makeOp(spicy::operator_::Kind kind, const expression_list& ops, const Location& l)
{
...
opt_cc        : CSTRING                          {
                                                   ...
                                                   else if ( $1 == "SPICY-HILTI" ) $$ = type::function::SPICY_HILTI;
                                                   else if ( $1 == "SPICY-HILTI-C" ) $$ = type::function::SPICY_HILTI_C;
                                                   else if ( $1 == "HILTI-C" ) $$ = type::function::HILTI_C;
                                                   else if ( $1 == "C" ) $$ = type::function::C;
                                                   else error(@$, "unknown calling convention");
                                                 }
              | /* empty */                      { $$ = type::function::SPICY; }
...
void spicy_parser::Parser::error(const Parser::location_type& l, const std::string& m)
{
    driver.error(m, l);
}
