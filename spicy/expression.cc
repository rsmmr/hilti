...
shared_ptr<spicy::Expression> Expression::coerceTo(shared_ptr<Type> target)
{
#if 0
    ...
    if ( t->equal(target) || ast::rtti::isA<type::Any>(target) )
        return sharedPtr<spicy::Expression>();
    ...
    return std::make_shared<CoercedExpression>(sharedPtr<spicy::Expression>(), target, location());
}
...
expression::List::List(const expression_list& exprs, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::List<AstInfo>(this, exprs)
{
}

expression::Constant::Constant(shared_ptr<spicy::Constant> constant, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Constant<AstInfo>(this, constant)
{
}

expression::Ctor::Ctor(shared_ptr<spicy::Ctor> ctor, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Ctor<AstInfo>(this, ctor)
{
}

expression::Module::Module(shared_ptr<spicy::Module> module, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Module<AstInfo>(this, module)
{
}

expression::Type::Type(shared_ptr<spicy::Type> type, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Type<AstInfo>(this, type)
{
}

expression::Variable::Variable(shared_ptr<spicy::Variable> var, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Variable<AstInfo>(this, var)
{
}

expression::ID::ID(shared_ptr<spicy::ID> id, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::ID<AstInfo>(this, id)
{
}

expression::Parameter::Parameter(shared_ptr<spicy::type::function::Parameter> param,
                                 const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Parameter<AstInfo>(this, param)
{
}

expression::Function::Function(shared_ptr<spicy::Function> func, const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Function<AstInfo>(this, func)
{
}

expression::Coerced::Coerced(shared_ptr<spicy::Expression> expr, shared_ptr<spicy::Type> dst,
                             const Location& l)
    : spicy::Expression(l), ast::expression::mixin::Coerced<AstInfo>(this, expr, dst)
{
}

expression::CodeGen::CodeGen(shared_ptr<spicy::Type> type, shared_ptr<hilti::Expression> value,
                             const Location& l)
    : CustomExpression(l)
{
    _type = type;
...
expression::MemberAttribute::MemberAttribute(shared_ptr<spicy::ID> id, const Location& l)
    : CustomExpression(l)
{
    _attribute = id;
...
shared_ptr<spicy::ID> expression::MemberAttribute::id() const
{
    return _attribute;
}
...
expression::ParserState::ParserState(Kind kind, shared_ptr<spicy::ID> id, shared_ptr<Type> unit,
...
shared_ptr<spicy::ID> expression::ParserState::id() const
{
    return _id;
}
...
void expression::ParserState::setType(shared_ptr<spicy::Type> type)
{
    removeChild(_type);
...
expression::UnresolvedOperator::UnresolvedOperator(spicy::operator_::Kind kind,
...
expression::PlaceHolder::PlaceHolder(shared_ptr<spicy::Type> type, const Location& l)
    : CustomExpression(l)
{
    _type = type;
    addChild(_type);
...
shared_ptr<spicy::ID> expression::ListComprehension::variable() const
{
    return _variable;
}
