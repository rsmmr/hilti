...
trait::parameter::Type::Type(shared_ptr<spicy::Type> type)
{
    _type = type;
}

shared_ptr<spicy::Type> trait::parameter::Type::type() const
{
    return _type;
}
...
shared_ptr<spicy::Type> trait::Parseable::fieldType()
{
    auto t = ast::rtti::tryCast<spicy::Type>(this);
    assert(t);
    return t->sharedPtr<spicy::Type>();
}
...
spicy::Type::Type(const Location& l) : ast::Type<AstInfo>(l)
{
}

shared_ptr<Scope> spicy::Type::typeScope()
{
    return nullptr;
}
...
shared_ptr<spicy::Type> OptionalArgument::argType() const
{
    return _arg;
}

bool OptionalArgument::equal(shared_ptr<spicy::Type> other) const
{
...
string spicy::Type::docRender()
{
    return render();
}

PacType::PacType(const Location& l) : spicy::Type(l)
{
    _attrs = std::make_shared<AttributeSet>(l);
}

PacType::PacType(const attribute_list& attrs, const Location& l) : spicy::Type(l)
{
...
bool TypedPacType::_equal(shared_ptr<spicy::Type> other) const
{
...
Any::Any(const Location& l) : spicy::Type(l)
{
    setMatchesAny(true);
}


Unknown::Unknown(const Location& l) : spicy::Type(l)
{
}

Unknown::Unknown(shared_ptr<ID> id, const Location& l) : spicy::Type(l)
{
    _id = id;
    addChild(_id);
}
...
TypeByName::TypeByName(shared_ptr<ID> id, const Location& l) : spicy::Type(l)
{
    _id = id;
}
...
bool TypeByName::_equal(shared_ptr<spicy::Type> other) const
{
...
MemberAttribute::MemberAttribute(shared_ptr<ID> attr, const Location& l) : spicy::Type(l)
{
    _attribute = attr;
    addChild(_attribute);
}

MemberAttribute::MemberAttribute(const Location& l) : spicy::Type(l)
{
    setWildcard(true);
}
...
bool MemberAttribute::_equal(shared_ptr<spicy::Type> other) const
{
...
type::Module::Module(const Location& l) : spicy::Type(l)
{
}

Void::Void(const Location& l) : spicy::Type(l)
{
}
...
{
    return {{"byteorder",
             std::make_shared<type::TypeByName>(std::make_shared<ID>("Spicy::ByteOrder")), nullptr,
             false},
...
shared_ptr<Scope> Bitset::typeScope()
{
    ...
    for ( auto label : _labels ) {
        ...
        auto p2 = ast::rtti::tryCast<spicy::Type>(p);
...
Bitfield::Bitfield(int width, const bits_list& bits, const Location& l)
{
    ...
    setBits(bits);
    setBitOrder(std::make_shared<expression::ID>(std::make_shared<ID>("Spicy::BitOrder::LSB0")));
}
...
{
    return {
        {"byteorder", std::make_shared<type::TypeByName>(std::make_shared<ID>("Spicy::ByteOrder")),
         nullptr, false},
        {"bitorder", std::make_shared<type::TypeByName>(std::make_shared<ID>("Spicy::BitOrder")),
         nullptr, false},
    };
}
...
std::list<trait::Parseable::ParseAttribute> Double::parseAttributes() const
{
    return {
        {"byteorder", std::make_shared<type::TypeByName>(std::make_shared<ID>("Spicy::ByteOrder")),
         nullptr, false},
        {"precision", std::make_shared<type::TypeByName>(std::make_shared<ID>("Spicy::Precision")),
         std::make_shared<expression::ID>(std::make_shared<ID>("Spicy::Precision::Double")), true},
    };
}
...
bool Integer::_equal(shared_ptr<spicy::Type> other) const
{
...
bool Tuple::_equal(shared_ptr<spicy::Type> other) const
{
    return trait::Parameterized::equal(other);
}

TypeType::TypeType(shared_ptr<spicy::Type> type, const Location& l) : spicy::Type(l)
{
    _rtype = type;
    addChild(_rtype);
}

TypeType::TypeType(const Location& l) : spicy::Type()
{
    setWildcard(true);
}

shared_ptr<spicy::Type> TypeType::typeType() const
{
    return _rtype;
}

bool TypeType::_equal(shared_ptr<spicy::Type> other) const
{
...
type::Function::Function(shared_ptr<type::function::Result> result, const parameter_list& args,
    ...
    : spicy::Type(l), ast::type::mixin::Function<AstInfo>(this, result, args)
{
    _cc = cc;
}
...
bool type::Function::_equal(shared_ptr<spicy::Type> o) const
{
...
function::Parameter::Parameter(shared_ptr<spicy::ID> id, shared_ptr<Type> type, bool constant,
...
type::Hook::Hook(shared_ptr<spicy::type::function::Result> result, const parameter_list& args,
                 const Location& l)
    : Function(result, args, type::function::SPICY)
{
}
...
shared_ptr<spicy::Type> Bytes::elementType()
{
...
shared_ptr<spicy::Type> List::iterType()
{
    return std::make_shared<iterator::List>(this->sharedPtr<Type>(), location());
}

shared_ptr<spicy::Type> List::elementType()
{
    return argType();
}
...
shared_ptr<spicy::Type> Vector::iterType()
{
    return std::make_shared<iterator::Vector>(this->sharedPtr<Type>(), location());
}

shared_ptr<spicy::Type> Vector::elementType()
{
    return argType();
}
...
shared_ptr<spicy::Type> Set::iterType()
{
    return std::make_shared<iterator::Set>(this->sharedPtr<Type>(), location());
}

shared_ptr<spicy::Type> Set::elementType()
{
    return argType();
}
...
bool RegExp::_equal(shared_ptr<spicy::Type> other) const
{
    return trait::Parameterized::equal(other);
}
...
shared_ptr<spicy::Type> RegExp::fieldType()
{
...
void unit::Item::addHook(shared_ptr<spicy::Hook> hook)
{
    _hooks.push_back(hook);
    addChild(_hooks.back());
}

void unit::Item::setType(shared_ptr<spicy::Type> type)
{
    removeChild(_type);
    _type = type;
    addChild(_type);
...
shared_ptr<spicy::Expression> unit::Item::inheritedProperty(const string& property)
{
    if ( ! _unit )
        return nullptr;
...
unit::item::Field::Field(shared_ptr<ID> id, shared_ptr<spicy::Type> type, Kind kind,
...
unit::item::field::Constant::Constant(shared_ptr<ID> id, shared_ptr<spicy::Constant> const_,
...
shared_ptr<spicy::Constant> unit::item::field::Constant::constant() const
{
    return _const;
}

unit::item::field::Unknown::Unknown(shared_ptr<ID> id, shared_ptr<spicy::ID> scope_id, Kind kind,
                                    shared_ptr<Expression> cond, const hook_list& hooks,
                                    const attribute_list& attrs, const expression_list& params,
                                    const expression_list& sinks, const Location& l)
...
shared_ptr<spicy::ID> unit::item::field::Unknown::scopeID() const
{
    return _scope_id;
}

unit::item::field::AtomicType::AtomicType(shared_ptr<ID> id, shared_ptr<spicy::Type> type,
                                          Kind kind, shared_ptr<Expression> cond,
                                          const hook_list& hooks, const attribute_list& attrs,
                                          const expression_list& sinks, const Location& l)
...
unit::item::field::Unit::Unit(shared_ptr<ID> id, shared_ptr<spicy::Type> type, Kind kind,
                              shared_ptr<Expression> cond, const hook_list& hooks,
                              const attribute_list& attrs, const expression_list& params,
                              const expression_list& sinks, const Location& l)
...
unit::item::field::Ctor::Ctor(shared_ptr<ID> id, shared_ptr<spicy::Ctor> ctor, Kind kind,
                              shared_ptr<Expression> cond, const hook_list& hooks,
...
shared_ptr<spicy::Ctor> unit::item::field::Ctor::ctor() const
{
    return _ctor;
}
...
shared_ptr<spicy::Type> unit::item::field::container::List::type()
{
...
shared_ptr<spicy::Type> unit::item::field::container::Vector::type()
{
    // FIXME: This is odd ... We should be able to return the new type
    // directly, but if we do, some checkedTrait later fail with random
    // crashes. Not sure what's going on, but storing the type via setType()
...
unit::item::Variable::Variable(shared_ptr<spicy::ID> id, shared_ptr<spicy::Type> type,
...
bool Unit::_equal(shared_ptr<spicy::Type> ty) const
{
                                                      ...
                                                      shared_ptr<type::unit::Item> item)
{
    ...
    auto module = firstParent<::spicy::Module>();
