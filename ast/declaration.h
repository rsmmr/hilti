...
#define __DECLARATION_MIXIN                                                                        \
    ::ast::MixIn<typename AstInfo::declaration, typename ::ast::DeclarationOverrider<AstInfo>>
...
public:
    ...
    shared_ptr<AIExpression> constant() const
    {
        return _expr;
    }
...
public:
    ...
    shared_ptr<AIFunction> function() const
    {
        return _func;
    }
