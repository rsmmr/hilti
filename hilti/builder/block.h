...
public:
    ...
    shared_ptr<::hilti::expression::Variable> addLocal(
        shared_ptr<::hilti::ID> id, shared_ptr<Type> type,
        shared_ptr<::hilti::Expression> init = nullptr, const AttributeSet& attrs = AttributeSet(),
    ...
    /// Returns: An expression referencing the local.
    shared_ptr<::hilti::expression::Variable> addLocal(
        const std::string& id, shared_ptr<Type> type,
        shared_ptr<::hilti::Expression> init = nullptr, const AttributeSet& attrs = AttributeSet(),
        bool force_unique = false, const Location& l = Location::None);
    ...
    ///
    shared_ptr<::hilti::expression::Variable> addTmp(shared_ptr<::hilti::ID> id,
                                                     shared_ptr<Type> type,
                                                     shared_ptr<::hilti::Expression> init = nullptr,
                                                     bool reuse = false,
    ...
    /// either case.
    std::tuple<shared_ptr<BlockBuilder>, shared_ptr<BlockBuilder>> addIf(
        shared_ptr<::hilti::Expression> cond, const Location& l = Location::None);
    ...
    addIfElse(shared_ptr<::hilti::Expression> cond, const Location& l = Location::None);
    ...
    typedef std::list<
        std::pair<shared_ptr<::hilti::Expression>, shared_ptr<::hilti::builder::BlockBuilder>>>
        case_list;
    ...
    void addSwitch(shared_ptr<::hilti::Expression> expr,
                   shared_ptr<::hilti::builder::BlockBuilder> default_, const case_list& cases);
...
protected:
    ...
    BlockBuilder(shared_ptr<statement::Block> block, shared_ptr<statement::Block> body,
                 ModuleBuilder* mbuilder);

    void setBody(shared_ptr<statement::Block> body)
    {
        _body = body;
    }
