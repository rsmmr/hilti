...
BlockBuilder::BlockBuilder(shared_ptr<statement::Block> block, shared_ptr<statement::Block> body,
...
shared_ptr<hilti::expression::Variable> BlockBuilder::addLocal(shared_ptr<hilti::ID> id,
...
shared_ptr<hilti::expression::Variable> BlockBuilder::addLocal(const std::string& id,
                                                               shared_ptr<Type> type,
                                                               shared_ptr<Expression> init,
                                                               const AttributeSet& attrs,
                                                               bool force_unique, const Location& l)
...
shared_ptr<hilti::expression::Variable> BlockBuilder::addTmp(shared_ptr<hilti::ID> id,
                                                             shared_ptr<Type> type,
                                                             shared_ptr<Expression> init,
...
shared_ptr<hilti::expression::Variable> BlockBuilder::addTmp(const std::string& id,
                                                             shared_ptr<Type> type,
                                                             shared_ptr<Expression> init,
                                                             bool reuse, const Location& l)
{
...
shared_ptr<statement::Instruction> BlockBuilder::addInstruction(
    shared_ptr<Expression> target, shared_ptr<Instruction> ins, shared_ptr<Expression> op1,
    shared_ptr<Expression> op2, shared_ptr<Expression> op3, const Location& l)
{
...
std::tuple<shared_ptr<BlockBuilder>, shared_ptr<BlockBuilder>> BlockBuilder::addIf(
    shared_ptr<Expression> cond, const Location& l)
{
    auto true_ = _mbuilder->newBuilder("if-true", l);
    auto cont = _mbuilder->newBuilder("if-cont", l);

    _mbuilder->builder()->addInstruction(hilti::instruction::flow::IfElse, cond, true_->block(),
                                         cont->block(), l);

    return std::make_tuple(true_, cont);
}

std::tuple<shared_ptr<BlockBuilder>, shared_ptr<BlockBuilder>, shared_ptr<BlockBuilder>>
BlockBuilder::addIfElse(shared_ptr<Expression> cond, const Location& l)
{
    auto true_ = _mbuilder->newBuilder("if-true", l);
...
void BlockBuilder::addDebugMsg(
    const std::string& stream, const std::string& msg, shared_ptr<hilti::Expression> arg1,
    shared_ptr<hilti::Expression> arg2, shared_ptr<hilti::Expression> arg3,
    shared_ptr<hilti::Expression> arg4, shared_ptr<hilti::Expression> arg5,
    shared_ptr<hilti::Expression> arg6, shared_ptr<hilti::Expression> arg7,
    shared_ptr<hilti::Expression> arg8, shared_ptr<hilti::Expression> arg9,
    shared_ptr<hilti::Expression> arg10, shared_ptr<hilti::Expression> arg11,
    shared_ptr<hilti::Expression> arg12, shared_ptr<hilti::Expression> arg13)
{
    ...
    if ( arg11 )
        elems.push_back(arg11);

    if ( arg12 )
        elems.push_back(arg12);

    if ( arg13 )
        elems.push_back(arg13);
    ...
    _mbuilder->builder()->addInstruction(hilti::instruction::debug::Msg,
                                         ...
                                         hilti::builder::string::create(msg), t);
}
...
{
    _mbuilder->builder()->addInstruction(hilti::instruction::debug::InternalError,
                                         builder::string::create(msg));
}
...
void BlockBuilder::addThrow(const std::string& ename, shared_ptr<hilti::Expression> arg)
{
    ...
    if ( ! arg )
        _mbuilder->builder()->addInstruction(excpt, ::hilti::instruction::exception::New,
                                             hilti::builder::type::create(etype));
    else
        _mbuilder->builder()->addInstruction(excpt, ::hilti::instruction::exception::NewWithArg,
                             ...
                             const case_list& cases)
{
    ...
    _mbuilder->builder()->addInstruction(::hilti::instruction::flow::Switch, expr,
                                         default_->block(), builder::tuple::create(tuple));
}
