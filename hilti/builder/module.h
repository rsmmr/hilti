...
public:
    ...
    ModuleBuilder(shared_ptr<CompilerContext> ctx, shared_ptr<hilti::ID> id,
    ...
    ///
    /// l: A location associated with the module.
    ModuleBuilder(shared_ptr<CompilerContext> ctx, const std::string& id,
                  const std::string& path = "-", const Location& l = Location::None);
    ...
    shared_ptr<hilti::declaration::Function> pushFunction(shared_ptr<hilti::Function> func,
                                                          bool no_body = false);
    ...
    ///
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> declareFunction(
    ...
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> declareFunction(
        shared_ptr<ID> id, std::shared_ptr<hilti::type::Function> type,
        const Location& l = Location::None);
    ...
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> declareFunction(
        const std::string& id, std::shared_ptr<hilti::type::Function> type,
        const Location& l = Location::None);
    ...
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> declareFunction(
        const std::string& id, shared_ptr<hilti::function::Result> result = nullptr,
        const hilti::function::parameter_list& params = hilti::function::parameter_list(),
        hilti::type::function::CallingConvention cc = hilti::type::function::HILTI,
        const hilti::AttributeSet& attrs = hilti::AttributeSet(),
        const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the hook.
    shared_ptr<hilti::declaration::Function> declareHook(
        shared_ptr<ID> id, shared_ptr<hilti::function::Result> result = nullptr,
        const hilti::function::parameter_list& params = hilti::function::parameter_list(),
        const hilti::AttributeSet& attrs = hilti::AttributeSet(),
        const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> pushFunction(
        shared_ptr<ID> id, shared_ptr<hilti::function::Result> result = nullptr,
        const hilti::function::parameter_list& params = hilti::function::parameter_list(),
        hilti::type::function::CallingConvention cc = hilti::type::function::HILTI,
        const hilti::AttributeSet& attrs = hilti::AttributeSet(), bool no_body = false,
        const Location& l = Location::None);
    ...
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> pushFunction(
        shared_ptr<ID> id, std::shared_ptr<hilti::type::Function> ftype, bool no_body = false,
        const Location& l = Location::None);
    ...
    /// Returns: An expression referencing the function.
    shared_ptr<hilti::declaration::Function> pushFunction(
        const std::string& name, std::shared_ptr<hilti::type::Function> ftype, bool no_body = false,
        const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the hook.
    shared_ptr<hilti::declaration::Function> pushHook(
        shared_ptr<ID> id, shared_ptr<hilti::function::Result> result = nullptr,
        const hilti::function::parameter_list& params = hilti::function::parameter_list(),
        const hilti::AttributeSet& attrs = hilti::AttributeSet(), bool no_body = false,
        const Location& l = Location::None);
    ...
    shared_ptr<hilti::declaration::Function> pushHook(
        shared_ptr<ID> id, shared_ptr<hilti::function::Result> result = nullptr,
        const hilti::function::parameter_list& params = hilti::function::parameter_list(),
        const hilti::AttributeSet& attrs = hilti::AttributeSet(), int64_t priority = 0,
        int64_t group = 0, bool no_body = false, const Location& l = Location::None);
    ...
    shared_ptr<hilti::declaration::Function> pushHook(
        ...
        int64_t priority, int64_t group, bool no_body = false, const Location& l = Location::None);
    ...
    shared_ptr<hilti::expression::Variable> addGlobal(shared_ptr<hilti::ID> id,
    ...
    shared_ptr<hilti::expression::Variable> declareGlobal(
        shared_ptr<hilti::ID> id, shared_ptr<Type> type, const AttributeSet& attrs = AttributeSet(),
        const Location& l = Location::None);
    ...
    /// Returns: An expressing referencing the declared global.
    shared_ptr<hilti::expression::Variable> declareGlobal(
        const std::string& name, shared_ptr<Type> type, const AttributeSet& attrs = AttributeSet(),
        const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the global.
    shared_ptr<hilti::expression::Variable> addGlobal(const std::string& id, shared_ptr<Type> type,
                                                      shared_ptr<Expression> init = nullptr,
                                                      const AttributeSet& attrs = AttributeSet(),
                                                      bool force_unique = false,
                                                      const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the global.
    shared_ptr<hilti::Expression> addConstant(shared_ptr<hilti::ID> id, shared_ptr<Type> type,
    ...
    ///
    /// Returns: An expression referencing the global.
    shared_ptr<hilti::Expression> addConstant(const std::string& id, shared_ptr<Type> type,
                                              shared_ptr<Expression> init,
                                              bool force_unique = false,
                                              const Location& l = Location::None);
    ...
    shared_ptr<hilti::expression::Variable> addLocal(shared_ptr<hilti::ID> id,
                                                     shared_ptr<Type> type,
                                                     shared_ptr<Expression> init = nullptr,
                                                     const AttributeSet& attrs = AttributeSet(),
                                                     bool force_unique = false,
    ...
    ///
    /// Returns: An expression referencing the local.
    shared_ptr<hilti::expression::Variable> addLocal(const std::string& id, shared_ptr<Type> type,
                                                     shared_ptr<Expression> init = nullptr,
                                                     const AttributeSet& attrs = AttributeSet(),
                                                     bool force_unique = false,
                                                     const Location& l = Location::None);
    ...
    shared_ptr<hilti::Type> addType(shared_ptr<hilti::ID> id, shared_ptr<Type> type,
                                    bool force_unique = false, const Location& l = Location::None);
    ...
    ///
    /// Returns: The added type.
    shared_ptr<hilti::Type> addType(const std::string& id, shared_ptr<Type> type,
                                    bool force_unique = false, const Location& l = Location::None);
    ...
    shared_ptr<hilti::expression::Type> addContext(shared_ptr<Type> type,
                                                   const Location& l = Location::None);
    ...
    shared_ptr<hilti::expression::Variable> addTmp(shared_ptr<hilti::ID> id, shared_ptr<Type> type,
                                                   shared_ptr<Expression> init = nullptr,
                                                   bool reuse = false,
                                                   const Location& l = Location::None);
    ...
    ///
    /// Returns: An expression referencing the variable.
    shared_ptr<hilti::expression::Variable> addTmp(const std::string& id, shared_ptr<Type> type,
                                                   shared_ptr<Expression> init = nullptr,
                                                   bool reuse = false,
                                                   const Location& l = Location::None);
...
private:
    shared_ptr<hilti::expression::Variable> _addLocal(
        shared_ptr<statement::Block> stmt, shared_ptr<hilti::ID> id, shared_ptr<Type> type,
        shared_ptr<Expression> init = nullptr, const AttributeSet& attrs = AttributeSet(),
        bool force_unique = false, const Location& l = Location::None);
    ...
    std::pair<shared_ptr<ID>, shared_ptr<Declaration>> _uniqueDecl(shared_ptr<ID> id,
                                                                   shared_ptr<Type> type,
                                                                   const std::string& kind,
                                                                   declaration_map* decls,
                                                                   _DeclStyle style, bool global);
    void _addDecl(shared_ptr<ID> id, shared_ptr<Type> type, const std::string& kind,
                  declaration_map* decls, shared_ptr<Declaration>);
    ...
    void Init(shared_ptr<CompilerContext> ctx, shared_ptr<ID> id, const std::string& path,
              const Location& l);
