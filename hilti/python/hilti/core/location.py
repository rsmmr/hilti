...
class Location(object):
    ...
    def markInternal(self):
        """Marks the location as one internal to the HILTI system. This can
        for example by used to differentiate user-defined IDs from those
        defined by HILTI's run-time system."""
        self._internal = True
        
    def internal(self):
        """Returns whether the function has been marked as internal.
        
        Returns: bool - True if ~~markInternal() has been called for this
        location.
        """
