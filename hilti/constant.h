...
public:
    ConstantParseError(Constant* c, const string& msg) : ast::RuntimeError(msg, c)
    {
    }

    ConstantParseError(shared_ptr<Constant> c, const string& msg) : ast::RuntimeError(msg, c.get())
    {
    }
};
...
public:
    ...
    String(string value, const Location& l = Location::None)
        : ast::SpecificConstant<AstInfo, Constant, string>(value,
                                                           shared_ptr<Type>(new type::String()), l)
    {
    }
...
public:
    ...
    Bool(bool value, const Location& l = Location::None)
        : ast::SpecificConstant<AstInfo, Constant, bool>(value, shared_ptr<Type>(new type::Bool()),
                                                         l)
    {
    }
...
public:
    ...
    Label(string id, const Location& l = Location::None)
        : ast::SpecificConstant<AstInfo, Constant, string>(id, shared_ptr<Type>(new type::Label()),
                                                           l)
    {
    }
...
public:
    ...
    Unset(const Location& l = Location::None)
        : ast::SpecificConstant<AstInfo, Constant, bool>(false, shared_ptr<Type>(new type::Unset()),
                                                         l)
    {
    }
...
public:
    ...
    Double(double value, const Location& l = Location::None)
        : ast::SpecificConstant<AstInfo, Constant, double>(value,
                                                           shared_ptr<Type>(new type::Double()), l)
    {
    }
...
public:
    ...
    ///
    /// l: An associated location.
    Union(shared_ptr<Type> utype, shared_ptr<ID> field, shared_ptr<Expression> value,
