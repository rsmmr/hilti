...
declare void @hlt_report_local_exception(i8*)
...
define ccc void @hlt_call_hilti(%__hlt_function_pointer, %__hlt_basic_frame*)
{
...
define fastcc void @__hlt_standard_cont_except(%__hlt_basic_frame*)
{
    ...
    call ccc void @hlt_report_local_exception(i8* %exception)
