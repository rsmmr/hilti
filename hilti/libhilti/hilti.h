...
typedef struct __hlt_string __hlt_string_constant;
...
extern __hlt_string hilti_fmt(__hlt_string fmt, const __hlt_type_info* type, const void* tuple, __hlt_exception* excpt);
...
typedef struct
{
    ...
    __hlt_list* debug_streams; // list<string> 
} hilti_config;
