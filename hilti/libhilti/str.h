...
extern hlt_string hlt_string_substr(hlt_string s1, hlt_string_size pos, hlt_string_size len, hlt_exception** excpt, hlt_execution_context* ctx);
...
extern hlt_string hlt_string_sprintf(hlt_string fmt, const hlt_type_info* type, void* (*tuple[]), hlt_exception** excpt, hlt_execution_context* ctx);
extern struct hlt_bytes* hlt_string_encode(hlt_string s, hlt_string charset, hlt_exception** excpt, hlt_execution_context* ctx);
extern hlt_string hlt_string_decode(struct hlt_bytes*, hlt_string charset, hlt_exception** excpt, hlt_execution_context* ctx);
