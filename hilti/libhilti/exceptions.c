...
hlt_exception_type hlt_exception_pktsrc_exhausted = { "PktSrcExhausted", &hlt_exception_unspecified, 0 };
hlt_exception_type hlt_exception_pktsrc_error = { "PktSrcError", &hlt_exception_unspecified, &hlt_type_info_string };
