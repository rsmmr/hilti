...
typedef struct hlt_regexp_span_result hlt_regexp_span_result;
...
extern hlt_regexp_span_result hlt_regexp_string_span(hlt_regexp* re, hlt_string s, hlt_exception* excpt);
