...
static void _bytesUnpackFixed(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result,
                              bool skip, bool eod_ok)
{
...
static void _bytesUnpackRunLength(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result,
                                  bool skip)
{
    auto iter_type = builder::iterator::typeBytes();

    auto len = cg->llvmUnpack(builder::integer::type(64), args.begin, args.end, args.arg, nullptr,
...
static void _bytesUnpackDelim(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result,
                              bool skip)
{
    auto iter_type = builder::iterator::typeBytes();
...
void Unpacker::visit(type::Bytes* t)
{
    ...
    cases.push_back(CodeGen::SwitchCase("bytes-run-length",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackRunLength(cg, args, result, false);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-fixed", cg()->llvmEnum("Hilti::Packed::BytesFixed"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackFixed(cg, args, result, false, false);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-fixed-or-eod",
                                        cg()->llvmEnum("Hilti::Packed::BytesFixedOrEod"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackFixed(cg, args, result, false, true);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-delim", cg()->llvmEnum("Hilti::Packed::BytesDelim"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackDelim(cg, args, result, false);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-run-length-skip",
                                        cg()->llvmEnum("Hilti::Packed::SkipBytesRunLength"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackRunLength(cg, args, result, true);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-fixed-skip",
                                        cg()->llvmEnum("Hilti::Packed::SkipBytesFixed"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackFixed(cg, args, result, true, false);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-fixed-skip-or-eod",
                                        cg()->llvmEnum("Hilti::Packed::SkipBytesFixed"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackFixed(cg, args, result, true, true);
                                            return nullptr;
                                        }));

    cases.push_back(CodeGen::SwitchCase("bytes-delim-skip",
                                        cg()->llvmEnum("Hilti::Packed::SkipBytesDelim"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _bytesUnpackDelim(cg, args, result, true);
                                            return nullptr;
                                        }));
...
static void _integerUnpack(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result,
                           int width, bool sign, ABI::ByteOrder order, const std::list<int> bytes)
{
    auto iter_type = builder::iterator::typeBytes();
    ...
    for ( auto i : bytes ) {
        llvm::Value* byte =
            cg->llvmCallC("__hlt_bytes_extract_one", {result.iter_ptr, args.end}, true);
...
void Unpacker::visit(type::Integer* t)
{
    ...
    cases.push_back(CodeGen::SwitchCase("int8l", i8l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 8, true, ABI::LittleEndian, {0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int16l", i16l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 16, true, ABI::LittleEndian, {0, 1});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int32l", i32l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 32, true, ABI::LittleEndian, {0, 1, 2, 3});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int64l", i64l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 64, true, ABI::LittleEndian, {0, 1, 2, 3, 4, 5, 6, 7});
        return nullptr;
    }));
    ...
    cases.push_back(CodeGen::SwitchCase("int8b", i8b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 8, true, ABI::BigEndian, {0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int16b", i16b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 16, true, ABI::BigEndian, {1, 0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int32b", i32b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 32, true, ABI::BigEndian, {3, 2, 1, 0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("int64l", i64b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 64, true, ABI::BigEndian, {7, 6, 5, 4, 3, 2, 1, 0});
        return nullptr;
    }));
    ...
    cases.push_back(CodeGen::SwitchCase("uint8l", u8l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 8, false, ABI::LittleEndian, {0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint16l", u16l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 16, false, ABI::LittleEndian, {0, 1});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint32l", u32l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 32, false, ABI::LittleEndian, {0, 1, 2, 3});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint64l", u64l, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 64, false, ABI::LittleEndian, {0, 1, 2, 3, 4, 5, 6, 7});
        return nullptr;
    }));
    ...
    cases.push_back(CodeGen::SwitchCase("uint8b", u8b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 8, false, ABI::BigEndian, {0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint16b", u16b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 16, false, ABI::BigEndian, {1, 0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint32b", u32b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 32, false, ABI::BigEndian, {3, 2, 1, 0});
        return nullptr;
    }));

    cases.push_back(CodeGen::SwitchCase("uint64b", u64b, [&](CodeGen* cg) -> llvm::Value* {
        _integerUnpack(cg, args, result, 64, false, ABI::BigEndian, {7, 6, 5, 4, 3, 2, 1, 0});
        return nullptr;
    }));
...
static void _addrUnpack4(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result, bool nbo)
{
    ...
    auto b = cg->llvmUnpack(builder::integer::type(32), args.begin, args.end, fmt, nullptr, nullptr,
                            args.location);
...
static void _addrUnpack6(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result, bool nbo)
{
    ...
    auto a = cg->llvmUnpack(builder::integer::type(64), args.begin, args.end, fmt, nullptr, nullptr,
                            args.location);
    auto b = cg->llvmUnpack(builder::integer::type(64), a.second, args.end, fmt, nullptr, nullptr,
                            args.location);
...
void Unpacker::visit(type::Address* t)
{
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv4", cg()->llvmEnum("Hilti::Packed::IPv4"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack4(cg, args, result, host_is_nbo);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv4-network",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack4(cg, args, result, true);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv4-little",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack4(cg, args, result, false);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv6", cg()->llvmEnum("Hilti::Packed::IPv6"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack6(cg, args, result, host_is_nbo);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv6-network",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack6(cg, args, result, true);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("addr-ipv6-little",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _addrUnpack6(cg, args, result, false);
                                            return nullptr;
                                        }));
...
static void _portUnpack(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result, bool nbo,
                        bool tcp)
{
    auto iter_type = builder::iterator::typeBytes();

    auto fmt = cg->llvmEnum(nbo ? "Hilti::Packed::Int16Big" : "Hilti::Packed::Int16");
    auto port = cg->llvmUnpack(builder::integer::type(16), args.begin, args.end, fmt, nullptr,
                               nullptr, args.location);
...
void Unpacker::visit(type::Port* t)
{
    ...
    cases.push_back(CodeGen::SwitchCase("port-tcp", cg()->llvmEnum("Hilti::Packed::PortTCP"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _portUnpack(cg, args, result, false, true);
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("port-udp-network",
                                        ...
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _portUnpack(cg, args, result, true, false);
                                            return nullptr;
                                        }));
...
static void _doubleUnpack(CodeGen* cg, const UnpackArgs& args, const UnpackResult& result,
                          bool high_precision, const string& fmt)
{
    auto lfmt = cg->llvmEnum(fmt);
    auto val = cg->llvmUnpack(builder::integer::type(high_precision ? 64 : 32), args.begin,
                              args.end, lfmt, nullptr, nullptr, args.location);

    auto dtype = high_precision ? cg->llvmTypeDouble() : cg->llvmTypeFloat();
    auto d = cg->builder()->CreateBitCast(val.first, dtype);

    auto d2 = d;

    if ( ! high_precision )
        d2 = cg->builder()->CreateFPExt(d, cg->llvmTypeDouble());

    cg->llvmCreateStore(d2, result.value_ptr);
    cg->llvmCreateStore(val.second, result.iter_ptr);
}

void Unpacker::visit(type::Double* t)
{
    auto args = arg1();
    auto result = arg2();
    ...
    cases.push_back(
        CodeGen::SwitchCase("double-double-host", cg()->llvmEnum("Hilti::Packed::Double"),
                            [&](CodeGen* cg) -> llvm::Value* {
                                _doubleUnpack(cg, args, result, true, "Hilti::Packed::UInt64");
                                return nullptr;
                            }));
    ...
    cases.push_back(
        CodeGen::SwitchCase("double-double-network", cg()->llvmEnum("Hilti::Packed::DoubleNetwork"),
                            [&](CodeGen* cg) -> llvm::Value* {
                                _doubleUnpack(cg, args, result, true, "Hilti::Packed::UInt64Big");
                                return nullptr;
                            }));

    cases.push_back(CodeGen::SwitchCase("double-double-little",
                                        cg()->llvmEnum("Hilti::Packed::DoubleLittle"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _doubleUnpack(cg, args, result, true,
                                                          "Hilti::Packed::UInt64Little");
                                            return nullptr;
                                        }));
    ...
    cases.push_back(CodeGen::SwitchCase("double-float-host", cg()->llvmEnum("Hilti::Packed::Float"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _doubleUnpack(cg, args, result, false,
                                                          "Hilti::Packed::UInt32");
                                            return nullptr;
                                        }));

    cases.push_back(
        CodeGen::SwitchCase("double-float-network", cg()->llvmEnum("Hilti::Packed::FloatNetwork"),
                            [&](CodeGen* cg) -> llvm::Value* {
                                _doubleUnpack(cg, args, result, false, "Hilti::Packed::UInt32Big");
                                return nullptr;
                            }));

    cases.push_back(CodeGen::SwitchCase("double-float-little",
                                        cg()->llvmEnum("Hilti::Packed::FloatLittle"),
                                        [&](CodeGen* cg) -> llvm::Value* {
                                            _doubleUnpack(cg, args, result, false,
                                                          "Hilti::Packed::UInt32Little");
                                            return nullptr;
                                        }));
