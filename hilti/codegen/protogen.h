...
protected:
    ...
    {
        setResult("hlt_match_token_state");
    }
    void visit(type::Network* t) override
    {
        setResult("hlt_network");
    }
    void visit(type::Overlay* t) override
    {
        setResult("hlt_overlay*");
    }
...
public:
    ...
    string mapType(shared_ptr<Type> type)
    {
        return type_mapper.mapType(type);
    }
