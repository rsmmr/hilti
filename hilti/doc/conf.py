...
latex_documents = [
  ('index', 'BinPac.tex', ur'BinPac++ Documentation',
...
def reformat_signature(app, what, name, obj, options, signature, return_annotation):
    if what != "class" or not name.startswith("ins.") or name.endswith("__init__"):
...
def add_signature(app, what, name, obj, options, lines):
    ...
    if what != "class" or not name.startswith("ins."):
        return 
