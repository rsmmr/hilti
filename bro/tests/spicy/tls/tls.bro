#
# @TEST-EXEC: bro -b -r ${TRACES}/tls/tls1.2.trace tls.evt ${SPICY}/tls.bro %INPUT >tls1.2
# @TEST-EXEC: btest-diff tls1.2
#
# @TEST-EXEC: bro -b -r ${TRACES}/tls/tls-conn-with-extensions.trace tls.evt ${SPICY}/tls.bro %INPUT >tls-extensions
# @TEST-EXEC: btest-diff tls-extensions
#
# @TEST-EXEC: bro -b -r ${TRACES}/tls/google.pcap tls.evt ${SPICY}/tls.bro %INPUT >google
