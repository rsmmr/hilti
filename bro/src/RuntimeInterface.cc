...
extern void libbro_object_mapping_unregister_bro(void* obj, hlt_exception** excpt,
                                                 hlt_execution_context* ctx);
extern void libbro_object_mapping_invalidate_bro(void* obj, hlt_exception** excpt,
                                                 hlt_execution_context* ctx);
