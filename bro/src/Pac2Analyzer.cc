...
Pac2_UDP_Analyzer::Pac2_UDP_Analyzer(Connection* conn) : Pac2_Analyzer(this), Analyzer(conn)
{
}
...
void Pac2_UDP_Analyzer::DeliverPacket(int len, const u_char* data, bool is_orig, uint64 seq,
