...
public:
     ...
     */
    std::string HiltiSymbol(const ::Func* func, shared_ptr<::hilti::Module> module,
                            bool include_module = false);
     ...
     * level after linking.
     */
    std::string HiltiStubSymbol(const ::Func* func, shared_ptr<::hilti::Module> module,
                                bool include_module);
     ...
     * level after linking.
     */
    std::string HiltiSymbol(const std::string& id, bool global, const std::string& module,
                            bool include_module = false);
     ...
     * XXX
     */
    void CacheCustomBroType(const BroType* btype, shared_ptr<::hilti::Type> htype,
                            const std::string& bro_id_name);

    /**
     * XXX
     */
    std::pair<shared_ptr<::hilti::Type>, std::string> LookupCachedCustomBroType(
        const BroType* btype);
...
private:
    std::string normalizeSymbol(const std::string sym, const std::string prefix,
                                const std::string postfix, const std::string& module, bool global,
                                bool include_module = false);
    bool CompileScripts();
