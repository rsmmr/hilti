 ...
 */
     ...
     */
    std::shared_ptr<::hilti::Expression> RuntimeValToHilti(std::shared_ptr<::hilti::Expression> val,
                                                           const ::BroType* type,
                                                           bool constant = false);
     ...
     * XXX
     */
    std::shared_ptr<::hilti::Expression> HiltiFromAny(std::shared_ptr<::hilti::Expression> val,
                                                      const ::BroType* type);
     ...
     */
    std::shared_ptr<::hilti::Expression> HiltiToAny(std::shared_ptr<::hilti::Expression> val,
                                                    const ::BroType* type);
     ...
     * XXX
     */
    shared_ptr<::hilti::Expression> HiltiCallFunction(const ::Expr* func, ::FuncType* ftype,
