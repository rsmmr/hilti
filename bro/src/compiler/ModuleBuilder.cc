...
namespace BifConst {
namespace Hilti {
extern int save_hilti;
}
}

using namespace bro::hilti::compiler;

ModuleBuilder::ModuleBuilder(class Compiler* arg_compiler, shared_ptr<::hilti::CompilerContext> ctx,
...
void ModuleBuilder::CompileScriptFunction(const BroFunc* func, bool exported)
{
    ...
    auto hfunc = pushFunction(id, ast::rtti::checkedCast<::hilti::type::Function>(ftype), false);
    ...
    CreateFunctionStub(func, [&](ModuleBuilder* mbuilder, shared_ptr<::hilti::Expression> rval,
                                 shared_ptr<::hilti::Expression> args) {
        auto ytype = func->FType()->YieldType();

        if ( ytype->Tag() != ::TYPE_VOID ) {
            shared_ptr<::hilti::Expression> result =
                mbuilder->addTmp("result", ftype->result()->type());

            mbuilder->Builder()->addInstruction(result, ::hilti::instruction::flow::CallResult,
                                                ::hilti::builder::id::create(func_name), args);

            auto nval = RuntimeHiltiToVal(result, ytype);
            Builder()->addInstruction(rval, ::hilti::instruction::operator_::Assign, nval);
        }
...
void ModuleBuilder::CompileEventStub(const ::BroFunc* event)
{
    ...
    CreateFunctionStub(event, [&](ModuleBuilder* mbuilder, shared_ptr<::hilti::Expression> rval,
                                  shared_ptr<::hilti::Expression> args) {
#if 0
        ...
        Builder()->addInstruction(rval, ::hilti::instruction::operator_::Assign,
...
{
    DBG_LOG_COMPILER("Compiling event function %s with %" PRIu64 " bodies", event->Name(),
                     event->GetBodies().size());
...
// Compile the event body into a hook.
        ...
        auto ftype = ast::rtti::checkedCast<::hilti::type::Hook>(type);

        if ( b.priority )
            ftype->attributes().add(::hilti::attribute::PRIORITY, b.priority);

        auto hook = pushHook(::hilti::builder::id::node(event_name), ftype, false);
...
void ModuleBuilder::CompileHook(const BroFunc* brohook, bool exported)
{
    ...
    for ( auto b : brohook->GetBodies() ) {
        ...
        auto hook = pushHook(::hilti::builder::id::node(hook_name), ftype, false);
    ...
    CreateFunctionStub(brohook, [&](ModuleBuilder* mbuilder, shared_ptr<::hilti::Expression> rval,
                                    shared_ptr<::hilti::Expression> args) {
        ...
        Builder()->addInstruction(result, ::hilti::instruction::hook::Run,
                                  ::hilti::builder::id::create(hook_name), args);
...
shared_ptr<::hilti::Expression> ModuleBuilder::DeclareScriptFunction(const ::BroFunc* func)
{
    ...
    declareFunction(::hilti::builder::id::node(name),
                    ast::rtti::checkedCast<::hilti::type::Function>(type));
    return id;
}
...
shared_ptr<::hilti::Expression> ModuleBuilder::DeclareEvent(const ::BroFunc* event)
{
    ...
    declareHook(::hilti::builder::id::node(name),
                ast::rtti::checkedCast<::hilti::type::Hook>(type));
...
std::shared_ptr<::hilti::Expression> ModuleBuilder::DeclareGlobal(const ::ID* id)
{
    ...
    // std::cerr << id->Name() << " " << symbol << " " << id->ModuleName() << " " <<
    // module()->id()->name() << std::endl;
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallFunction(const ::Expr* func,
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallFunctionViaBro(
    shared_ptr<::hilti::Expression> func, const ::FuncType* ftype, ListExpr* args,
    const ::BroType* target_type)
{
    switch ( ftype->Flavor() ) {
    case FUNC_FLAVOR_FUNCTION:
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallScriptFunctionHilti(
    const ::Func* func, shared_ptr<::hilti::Expression> args, const ::BroType* target_type)
{
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallEventHilti(
    const ::Func* func, shared_ptr<::hilti::Expression> args, const ::BroType* target_type)
{
    auto hfunc = DeclareFunction(func);
    ...
    Builder()->addInstruction(c, ::hilti::instruction::callable::NewHook,
                              ::hilti::builder::type::create(tc), hfunc, args);
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallHookHilti(
    const ::Func* func, shared_ptr<::hilti::Expression> args, const ::BroType* target_type)
{
    auto true_ = ::hilti::builder::boolean::create(true);
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallBuiltinFunctionHilti(
    const ::Func* func, shared_ptr<::hilti::Expression> args, const ::BroType* target_type)
{
    auto ftype = func->FType();
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallEventLegacy(
    shared_ptr<::hilti::Expression> fval, const ::FuncType* ftype, ListExpr* args,
    const ::BroType* target_type)
{
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallHookLegacy(
    shared_ptr<::hilti::Expression> fval, const ::FuncType* ftype, ListExpr* args,
    const ::BroType* target_type)
{
...
shared_ptr<::hilti::Expression> ModuleBuilder::HiltiCallFunctionLegacy(
    shared_ptr<::hilti::Expression> fval, const ::FuncType* ftype, ListExpr* args,
    const ::BroType* target_type)
{
    RecordType* fargs = ftype->Args();
