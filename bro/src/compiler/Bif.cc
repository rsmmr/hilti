...
int64_t global_clear_table_bif(hlt_LibBro_BroAny* any, hlt_exception** excpt,
...
int64_t dns_clear_table_bif(hlt_LibBro_BroAny* any, hlt_exception** excpt,
                            hlt_execution_context* ctx)
{
...
hlt_bytes* hilti_test_type_string_bif(hlt_bytes* b, hlt_exception** excpt,
                                      hlt_execution_context* ctx)
{
...
hlt_bytes* hiltitesting_mangle_string_bif(hlt_bytes* b, hlt_exception** excpt,
                                          hlt_execution_context* ctx)
{
