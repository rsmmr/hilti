...
void usage()
{
    ...
    cerr << "Usage: " << Name << " [options] <input.spicy>\n"
            "\n"
            "Options:\n"
            "\n"
            ...
            "  -n | --no-validate    Do not validate resulting Spicy or HILTI ASTs (for debugging only).\n"
            "  -o | --output <file>  Specify output file.                    [Default: stdout].\n"
            "  -p | --print          Just output all parsed Spicy code again.\n"
...
void version()
{
    cerr << Name << " v" << spicy::version() << endl;
}
...
{
    shared_ptr<spicy::Options> options = std::make_shared<spicy::Options>();
    ...
    auto ctx = std::make_shared<spicy::CompilerContext>(options);
