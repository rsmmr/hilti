...
binpac::CompilerContext::binpac_parsers_func JitParsers = nullptr;
...
void listParsers()
{
    ...
    hlt_list* parsers = (*JitParsers)(&excpt, ctx);
...
bool jitPac2(const std::list<string>& pac2, bool debug, int optlevel)
{
    ...
    JitParsers = PacContext->jitBinpacParser(llvm_module, optlevel);
